...
<form action="SanPhamServlet?action=update" method="post" enctype="multipart/form-data" class="p-4 bg-light rounded shadow">
        ...
        <div class="col-md-8"> 
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" class="form-control" id="giaSP" name="giaSP" value="${sanPham.giaSP}" min=0 step=1000>
    ...
    <div class="form-group d-flex justify-content-center"> 
        ...
        <a href="${pageContext.request.contextPath}/SanPhamServlet" class="btn btn-secondary" style="width:100px">Hủy</a> 
	</div>
</form>
