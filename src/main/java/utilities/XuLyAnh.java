...
public class XuLyAnh extends HttpServlet {
    ...
    public String luuAnh(HttpServletRequest request, ServletContext context) throws ServletException, IOException {
        // Đường dẫn thư mục trên server  
        String serverFilePath = context.getRealPath("") + File.separator + "views\\assets\\images\\HinhNguoiDung";
        ...
        String localFilePath = context.getRealPath("").substring(0, viTriCat) + "WebsiteCoffee" + File.separator + "src\\main\\webapp\\views\\assets\\images\\HinhNguoiDung";
